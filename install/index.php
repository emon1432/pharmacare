                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="password" class="form-control" id="purchase_key" value="<?php echo @$_GET['purchase_key'] ?>"  name="purchase_key"  placeholder="Download from https://doniaweb.com/" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<footer class="footer text-center">
    <div class="container fText">
        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
                <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="https://doniaweb.com" target="_blank">Licensed By DoniaWeB</a></div>
                <div class="col-sm-6  text-right"><a target="_blank" href="https://doniaweb.com/"><span class="glyphicon glyphicon-user"></span> Installation Support</a></div>
            </div>
        </div>
    </div>
</footer>
